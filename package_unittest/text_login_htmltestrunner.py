...
# 问题： 用unittest的测试报告太简单，只能在控制台查看，想生成的测试报告能更详细，能在游览器中打开。

# 解决方案： 使用HTMLTestrunner模块生成测试报告，原理：将运行的测试用例结果输出到了HTML文件中，就能用浏览器打开。
...
"""
from work.iter03_add_user import login
import unittest
import sys
